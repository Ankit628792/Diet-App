  ...
  return (
    <section className="w-full h-screen flex justify-center items-center">
      <form onSubmit={handleSubmit} className='max-w-lg w-full border border-emerald-300 sm:shadow-emerald-50 shadow-none p-5 py-10 sm:p-10 rounded-xl sm:shadow-lg flex flex-col justify-center items-center'>
        <h1 className='text-3xl lg:text-4xl font-semibold text-emerald-600 mb-4 text-center'>User Login</h1>
        ...
        <input className="py-2 px-5 my-4 rounded-3xl bg-emerald-500 text-white max-w-max text-xl font-semibold cursor-pointer" type="submit" value="Login" />
        <p className="text-lg">Don't have an account ? <Link to='/register' className="text-emerald-500 hover:text-emerald-500">Register</Link></p>
